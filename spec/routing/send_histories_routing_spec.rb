...
RSpec.describe SendHistoriesController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #show' do
      ...
      expect(get: "/send_histories/#{space_code}/detail").to route_to('send_histories#show', space_code: space_code)
      expect(get: "/send_histories/#{space_code}/detail.json").to route_to('send_histories#show', space_code: space_code, format: 'json')
    end
