...
RSpec.describe 'Users::Confirmations', type: :request do
  ...
  describe 'GET #show' do
    ...
    shared_examples '[*][存在しない/ない]確認日時がない（未確認）' do
    ...
    shared_examples '[ログイン中]トークンが期限内' do
      let_it_be(:confirmation_sent_at) { Time.now.utc }
