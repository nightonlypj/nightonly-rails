...
RSpec.describe 'Tasks', type: :request do
  ...
  describe 'GET #index (.by_priority)' do
    ...
    let_it_be(:task_none)   { FactoryBot.create(:task, :none, space: space, created_user: user) }
  ...
  describe 'GET #index (.by_start_end_date)' do
    ...
    let_it_be(:tasks_before) do
      [
        ...
        FactoryBot.create(:task, :before, space: space, created_user: user)
      ]
    end
    let_it_be(:tasks_active) do
      [
        FactoryBot.create(:task, :active, :no_end, space: space, created_user: user),
        FactoryBot.create(:task, :active, space: space, created_user: user)
      ]
    end
    let_it_be(:tasks_after) { [FactoryBot.create(:task, :after, space: space, created_user: user)] }
