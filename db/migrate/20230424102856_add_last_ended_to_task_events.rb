class AddLastEndedToTaskEvents < ActiveRecord::Migration[6.1]
  def change
    ...
    remove_index :task_events, %i[space_id started_date ended_date id], name: 'index_task_events3'
    add_index    :task_events, %i[space_id started_date id],            name: 'index_task_events3'
  end
end
