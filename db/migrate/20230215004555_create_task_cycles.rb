class CreateTaskCycles < ActiveRecord::Migration[6.1]
  def change
    ...
    add_index :task_cycles, %i[deleted_at space_id cycle month], name: 'index_task_cycles1'
    add_index :task_cycles, %i[updated_at id],                   name: 'index_task_cycles2'
    add_index :task_cycles, %i[deleted_at id],                   name: 'index_task_cycles3'
  end
end
