class CreateTasks < ActiveRecord::Migration[6.1]
  def change
    ...
    add_index :tasks, %i[space_id id],                      name: 'index_tasks1'
    add_index :tasks, :priority,                            name: 'index_tasks2'
    add_index :tasks, %i[space_id started_date ended_date], name: 'index_tasks3'
    add_index :tasks, %i[space_id ended_date],              name: 'index_tasks4'
    add_index :tasks, %i[created_user_id id],               name: 'index_tasks5'
    add_index :tasks, %i[last_updated_user_id id],          name: 'index_tasks6'
    add_index :tasks, %i[created_at id],                    name: 'index_tasks7'
    add_index :tasks, %i[updated_at id],                    name: 'index_tasks8'
  end
end
